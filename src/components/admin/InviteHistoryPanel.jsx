  ...
  return (
    <div className="space-y-2">
      {invites.map((inv) => {
        ...
        return (
          <div key={inv.id} className="flex items-center justify-between p-3 rounded-lg border border-slate-100 bg-white">
            <div className="flex items-center gap-3 min-w-0">
              <div className={`p-1.5 rounded-full ${accepted ? 'bg-green-50' : 'bg-amber-50'}`}>
                {accepted ? (
