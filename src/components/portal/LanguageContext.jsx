...
const translations = {
  en: {
    ...
    perDay: '/ day',
    rateNotSet: "Your daily rate hasn't been set yet. Contact your manager.",
    waysToIncrease: 'Ways to Increase Your Wage',
    osha: 'Get OSHA 30 Certified',
    oshaDesc: 'Safety certifications often lead to wage increases.',
    ...
    requestedRate: 'Requested Rate ($/day)',
  ...
  es: {
    ...
    perDay: '/ día',
    rateNotSet: 'Tu tarifa diaria aún no se ha establecido. Contacta a tu gerente.',
    waysToIncrease: 'Formas de Aumentar Tu Salario',
    osha: 'Obtener Certificación OSHA 30',
    oshaDesc: 'Las certificaciones de seguridad a menudo resultan en aumentos salariales.',
    ...
    requestedRate: 'Tarifa Solicitada ($/día)',
