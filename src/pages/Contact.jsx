  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <SEOHead 
        ...
        keywords="free renovation estimate Brooklyn, contact general contractor Brooklyn, home renovation quote Long Island, kitchen remodel estimate, bathroom renovation consultation Park Slope, free consultation contractor Five Towns, renovation estimate Long Island, home improvement quote Nassau County, schedule renovation appointment, Brooklyn contractor phone number, Long Island contractor contact"
      />
      <style>{`
