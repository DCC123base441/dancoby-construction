      ...
      <section className="py-16 md:py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-12">
            <p className="text-xs tracking-[2px] text-[#a39e96] uppercase mb-4">Follow Our Journey</p>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-6">@dancoby</h2>
          ...
          <motion.a
            href="https://www.instagram.com/dancoby/"
            target="_blank"
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 p-[2px]">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">Dancoby Construction</h3>
                <p className="text-gray-500 mb-6">Daily inspiration & project updates</p>
                <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white font-medium rounded-full group-hover:shadow-lg group-hover:shadow-pink-500/25 transition-all duration-300">
                  <span>Follow Us</span>
