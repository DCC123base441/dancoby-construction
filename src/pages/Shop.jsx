...
export default function Shop() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-zinc-900 py-24">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
            ...
            className="flex flex-col items-center">
                ...
                <p className="text-gray-300 mb-8 mx-auto text-xl font-light max-w-2xl">Official Dancoby apparel. Designed for the builders, the dreamers, and the doers. Support a great cause with every purchase.
