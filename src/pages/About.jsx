  ...
  return (
    <main className="min-h-screen bg-white">
      <SEOHead
        ...
        keywords="about Dancoby Construction, general contractor Brooklyn, Long Island contractor, licensed contractor Nassau County, home renovation experience, licensed insured contractor Brooklyn, 20 years renovation experience, trusted home builder Park Slope, customer first contractor, renovation company Five Towns, Brooklyn construction company, contractor Hewlett Woodmere" />
